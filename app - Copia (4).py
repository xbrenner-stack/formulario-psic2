...
class Empresa(Base):
    ...
    nome_responsavel = Column(String(200), default="") # CAMPO NOVO
    registro_responsavel = Column(String(200), default="") # CAMPO NOVO
...
# ATUALIZAÇÃO SEGURA DO BANCO DE DADOS (Não apaga seus dados atuais)
    ...
    if contexto == "[Administração Geral]":
        ...
        if menu == "👥 Funcionários":
            ...
            if not camps: st.info("Nenhuma campanha ativa.")
                ...
                # ABAS REORDENADAS COM A NOVA CAPA NO INÍCIO E METODOLOGIA ANTES DOS DADOS BRUTOS
                ...
                if df_b.empty: 
                    ...
                    # --- ABA CLASSIFICATÓRIA (CÉREBRO DA MATEMÁTICA E TEXTOS) ---
                    with tab_classif:
                        st.markdown("""
                        <style>
                        @media print {
                        ...
                        # Gerador de HTML para Tabelas Perfeitas na Impressão
                        ...
                        <div style='text-align: center; margin-bottom: 30px; line-height: 1.2;'>
                            <span style='color: black; font-size: 28px; font-weight: bold;'>Classificação Analítica dos Fatores de Risco</span><br>
                            <span style='color: black; font-size: 18px; font-weight: bold;'>Resultados do Inventário COPSOQ-II Versão Média e Proposições de Intervenção</span><br><br>
                        ...
                        """, unsafe_allow_html=True)
                        # A assinatura foi movida para a aba de Capa e Encerramento.
                ...
                # --- ABA DE METODOLOGIA (AGORA SEM ASSINATURA) ---
                with tab_metodo:
                    st.markdown("""
                    <style>
                    @media print {
